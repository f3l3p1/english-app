...
@NgModule({
  declarations: [AppComponent, LoginComponent, RegisterComponent, Tab1Page, Tab2Page, UpdateProfileComponent, SubscribePage], // Ensure LoginComponent is correctly declared
  imports: [
    BrowserModule,
